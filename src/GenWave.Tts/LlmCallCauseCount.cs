...
/// <c>/api/llm-calls</c> counter summary (<c>GenWave.Host.Api.LlmCallCauseSummaryDto</c>) and,
/// via <see cref="LlmCallCauseCounters.DominantFailure"/>, the red health tile's "dominant recent
/// cause" line.
/// </summary>
