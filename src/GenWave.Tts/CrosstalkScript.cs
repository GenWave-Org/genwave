...
/// marks — <see cref="CrosstalkScriptParser"/> is the only producer. What a LATER task (T285's
/// per-line render, T287's ffmpeg assembler) does with this — voicing each line through its own
/// speaker's <c>TtsRenderContext</c> and mixing the renders into one asset — is out of scope here;
/// this type is only the validated intermediate the writer hands off.
/// </summary>
