...
/// F168.1, F168.4; STORY-403; PLAN T416) — the <see cref="AdCastPicker"/> precedent narrowed to a
...
///
/// <para>
/// <b>Deterministic in the spot id alone (SPEC F168.4's own regeneration guarantee)</b> — a retry of
...
{
    /// <summary><see langword="null"/> when <paramref name="orderedPool"/> is empty (SPEC F168.5's
