...
description: >-
  SOLID object-oriented design principles — language-agnostic; applies
  equally to C# and TypeScript work (examples are written in TypeScript).
  Use when designing or refactoring classes and modules, reviewing code for
  design smells (rigid, fragile, tightly coupled code), deciding how to split
  ...
  principles with before/after examples and guidance on when applying them
  helps and when it is over-engineering.
---
