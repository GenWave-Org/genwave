...
│  └─ 02..36-*-migration.sh # idempotent in-place upgrades, one per shipped feature —
...
GenWave's epic-by-epic history — from v1 broadcast playout through "a station, not a
playlist" (context segments, top-of-hour idents, the straddle handoff — v3.3.x) — lives
