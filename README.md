...
GenWave's epic-by-epic history — from v1 broadcast playout through v5.1.0's "two in the
booth" (the voice contract lands, and the DJs learn to talk to each other) — lives
