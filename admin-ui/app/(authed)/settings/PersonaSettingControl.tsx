...
/** Matches SettingField's shipped single-line control styling. */
 ...
 * this control, not a second inline fetch; the same one-hook-per-listing idiom `useVoiceList`
 * follows for `GET /api/voices`, gh-#426). A current value the fetched roster doesn't recognize (a
