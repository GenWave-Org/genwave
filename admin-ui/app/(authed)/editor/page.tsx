...
// mirroring persona-catalog/page.tsx.
export const dynamic = "force-dynamic";
export const fetchCache = "force-no-store";

/** Fetches one JSON-array GET endpoint, degrading to `[]` on any failure (network error, non-200) —
 * fail closed, the same posture the retired Wardrobe page's `fetchCatalogEnabled` once took: no
 * live signal means nothing gets offered. This page's own two GET routes (`/api/themes`, `/api/fonts/assignable`)
