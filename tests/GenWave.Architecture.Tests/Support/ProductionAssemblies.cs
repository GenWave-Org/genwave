...
internal static class ProductionAssemblies
{
    ...
    public static readonly Assembly Context = typeof(GenWave.Context.ContextPipeline).Assembly;
    ...
    {
        Core, Orchestration, Tts, Loudness, Context, MediaLibrary, Host, Abstractions, Plugins,
    };
