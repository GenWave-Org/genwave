...
/// the Host graduation rule enforces. Seeded today with the two born-outside reservations the ruling
/// names explicitly — <c>IContextProvider</c> (gh-#378) and the Ads library (gh-#380) must not land
/// their logic in <c>GenWave.Host</c>. The graduated category (a subsystem that has since moved OUT
