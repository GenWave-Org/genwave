...
file sealed class BulkRatingApiWebFactory : WebApplicationFactory<Program>
{
    ...
    protected override IHost CreateHost(IHostBuilder builder)
    {
        ...
        // ConfigureTestServices runs), so it is injected via the environment. A non-reachable host
        // is fine: this scenario never resolves IMediaRating — [Consumes("application/json")]
        // rejects the request during routing/action-selection, before BulkRatingController is
        // constructed.
...
public static class FeatureBulkRatingEndpoints
{
    ...
    // BulkRatingApiWebFactory.CreateHost mutates the ConnectionStrings__Library process env var for
