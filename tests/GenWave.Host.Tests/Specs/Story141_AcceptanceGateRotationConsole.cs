...
public static class FeatureAcceptanceGateRotationConsole
{
    ...
    public sealed class ScenarioEngineAndComposeCarryZeroDiffFromMain
    {
        ...
        // the spectator listener-count poll — another intentional edit from a LATER epic, still not
        ...
        // LATER epic, still not a regression of Epic V's own F41–F45 zero-diff promise.
        // EngineScriptSha256 unchanged — this task does not touch engine/genwave.liq.
        //
        ...
        // epic, still not a regression of Epic V's own F41–F45 zero-diff promise.
        // EngineScriptSha256 unchanged — this task does not touch engine/genwave.liq. Re-pinned
        // again same day (T49 review fix, SPEC F78.5): the alloy healthcheck's bare
        // `grep -qi ready` matched Alloy's not-ready body too ("Alloy is not ready." still
        // contains "ready" as a substring), reporting healthy for a not-ready Alloy — now
